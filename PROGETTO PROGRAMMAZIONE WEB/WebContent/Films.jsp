<%@ page contentType="text/html; charset=UTF-8" import="java.util.*,oggetti.*,modelDM.*"%>
   ...
   Boolean adminR=(Boolean) session.getAttribute("adminR");
     ...
     GregorianCalendar oggi =new GregorianCalendar();    
      ...
      String[] g = lunedi.split("-");
		...
		int gg=Integer.parseInt(g[2]);		
				GregorianCalendar	mer=new GregorianCalendar(aa,mm,(gg+2));
     ...
     ProiezioneModelDM pm = new ProiezioneModelDM();
		...
		ArrayList<Proiezione> lunediPro =  pm.doRetrieveDistinctByDate(lunedi);
...
<script type="text/javascript"> 
  $(document).ready(function() {  
   $("li.film").css({"background-color":"rgba(255, 0, 0, 0.6)"});
...
<div class="body">
<p class="intestazione"> I FILM DI QUESTA SETTIMANA </p>
